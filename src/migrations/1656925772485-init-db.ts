...
export class initDb1656925772485 implements MigrationInterface {
    name = 'initDb1656925772485'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "room" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "price" integer NOT NULL, "currency" character varying NOT NULL DEFAULT 'VND', "rooms" integer NOT NULL, "address" character varying NOT NULL, "status" integer NOT NULL, "lat" integer NOT NULL, "lng" integer NOT NULL, "category_id" integer NOT NULL, CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "firstName" character varying NOT NULL, "last_name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "login_token" character varying, "phone_code" character varying NOT NULL DEFAULT '', "phone_number" character varying NOT NULL DEFAULT '', "dob" TIMESTAMP NOT NULL DEFAULT '"2022-07-04T09:09:34.893Z"', "is_active" boolean NOT NULL DEFAULT true, "role" character varying NOT NULL DEFAULT 'user', "reset_code" character varying, CONSTRAINT "UQ_80deb7bb86e43ebd8ca992429e6" UNIQUE ("login_token"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
